...
ogr2ogr -select CLIP_POLYGON_LAYER -t_srs EPSG:YOUR_CRS_EPSG -f SQLite projected_clip_polygon.sqlite YOUR_VEGETATION_POLYGON.shp
#reprojecting and clipping a raster to the shapefile above 
gdalwarp -t_srs EPSG:28356 -cutline projected_clip_polygon.sqlite -cl YOUR_VEGETATION_POLYGON Burn_ratio.tif Burn_proj.tif
